...
- [ADR-001 — Kafka 단방향 비동기 통합](adr/001-kafka-only-async-integration.md)
...
- [ADR-009 — Playwright for Java와 외부 앱 타겟 방식으로 E2E 테스트를 구성](adr/009-playwright-java-e2e-external-app-target.md)
