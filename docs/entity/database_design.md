...
| 주문 · 결제 · 배송 | 거래 | `orders`, `order_items`, `order_item_option_values`, `payments`, `shipments`, `shipment_items` | 주문 시점 스냅샷, 주문 1:N 배송 이행(V4) |
...
| seller_id | bigint | | 판매자 범위 이행용 이음매(backlog 002 — 현재 미사용, nullable) |
